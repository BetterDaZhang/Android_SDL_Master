...
Android_PumpEvents(_THIS)
{
    ...
    /*
     * Android_ResumeSem and Android_PauseSem are signaled from Java_com_example_zhangjunling_SDLActivity_nativePause and Java_com_example_zhangjunling_SDLActivity_nativeResume
